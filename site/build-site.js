...
function nav() {
  ...
  <div class="navlinks">
    ...
    <a class="btn line" href="/emojis.json">Get the data</a>
    <a class="btn dark gh" href="${REPO}" rel="noopener">${GH_ICON} Fork on GitHub</a>
  </div>
</nav>`;
}
...
<section class="section cta">
  ...
  <div class="ctarow reveal">
    <a class="btn line gh" href="${REPO}" rel="noopener">${GH_ICON} Fork on GitHub</a>
    <span class="ctanote">Open source under MIT. The data, the pipeline and this site live in one repo, so you can change any list and rebuild the whole thing.</span>
  </div>
</section>
` +
    footer(meta) +
